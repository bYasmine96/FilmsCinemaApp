 ...
 */
class ListeFilmEnProjectionAdapterDate (private val context: Context, arrayList: Array<MovieNow>) : RecyclerView.Adapter<ListeFilmEnProjectionAdapterDate.ViewHolder>()
{
